...
export class GameServiceService {
  public book;
  public current;
  public baseUrl = "https://anapioficeandfire.com";
  public token = 'NDVkZDg0YjNiZjk0Mzk1YWE5NTU2ZmUyMmQ1N2ZkMTUzMmI2NjE4ZTE2MTNjNjlkNzlmNjM1YTg5Yjg2M2I4NmRlZTA4N2U2OTU1NDRiNDZjMDFhZTBmOWMwNjQyZDM5OTBlMDUyYzFiZjI1NjE4ODRmNDU0ODUzOTUyMjk0YTRhYw==';
  public data = [
    {
  ...
  public getBook1(): any {
    let bookResponse = this.http1.get(this.baseUrl + '/api/books/' + '?authToken=' + this.token);
    /*'Access-Control-Allow-Origin' header is present on the requested resource. 
    Origin 'http://localhost:4200' is therefore not allowed access.
    this error is shown in console if authToken is not used*/
    console.log(bookResponse);
    console.log("checking if getbook works");
    return bookResponse;
  }

  public getChar1(): any {
    let charResponse = this.http1.get(this.baseUrl + '/api/characters/' + '?authToken=' + this.token);
    console.log(charResponse);
    console.log("checking if getchar works");
    return charResponse;
  }

  public getHouse1(): any {
    let houseResponse = this.http1.get(this.baseUrl + '/api/houses/' + '?authToken=' + this.token);
    console.log(houseResponse);
    console.log("checking if gethouse works");
